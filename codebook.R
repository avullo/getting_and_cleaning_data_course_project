...
write("In order to get the tidy data set ready for analysis, he following transformations are applied:", file = "CodeBook.md", append = TRUE)
...
write("This results in 81 values observations: 79 feature values plus subject/activity identifiers.", file = "CodeBook.md", append = TRUE)
...
write("This last step is particularly controversial as the given instruction gives room to multiple interpretation.", file = "CodeBook.md", append = TRUE)
