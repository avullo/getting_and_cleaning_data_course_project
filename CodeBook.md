...
**fbodyacc_meanfreq_x** _Frequency domain body acceleration weighted averate - x axis_

    Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
-0.63590 -0.39170 -0.25730 -0.23230 -0.06105  0.15910 

**fbodyacc_meanfreq_y** _Frequency domain body acceleration weighted averate - y axis_

     Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
-0.379500 -0.081310  0.007855  0.011530  0.086280  0.466500 

**fbodyacc_meanfreq_z** _Frequency domain body acceleration weighted averate - z axis_
...
**fbodyaccjerk_meanfreq_x** _Frequency domain body acceleration jerk signal weighted averate - x axis_

    Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
-0.57600 -0.28970 -0.06091 -0.06910  0.17660  0.33140 

**fbodyaccjerk_meanfreq_y** _Frequency domain body acceleration jerk signal weighted averate - y axis_

    Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
-0.60200 -0.39750 -0.23210 -0.22810 -0.04721  0.19570 

**fbodyaccjerk_meanfreq_z** _Frequency domain body acceleration jerk signal weighted averate - z axis_
...
**fbodygyro_meanfreq_x** _Frequency domain angular velocity weighted averate - x axis_

     Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
-0.395800 -0.213400 -0.115500 -0.104600  0.002655  0.249200 

**fbodygyro_meanfreq_y** _Frequency domain angular velocity weighted averate - y axis_

    Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
-0.66680 -0.29430 -0.15790 -0.16740 -0.04269  0.27310 

**fbodygyro_meanfreq_z** _Frequency domain angular velocity weighted averate - z axis_
...
**fbodyaccmag_meanfreq** _Frequency domain body acceleration magnitude weighted averate_
...
**fbodybodyaccjerkmag_meanfreq** _Frequency domain body acceleration jerk signal magnitude weighted averate_
...
**fbodybodygyromag_meanfreq** _Frequency domain angular velocity magnitude weighted averate_
...
**fbodybodygyrojerkmag_meanfreq** _Frequency domain angular velocity jerk signal magnitude weighted averate_
